...
(function () {
    ...
    initMinimizeSidebar: function () {
        $('#minimizeSidebar').click(function () {
            $(this);
            // !0 == sidebar_mini_active ? ($('body').removeClass('sidebar-mini'), sidebar_mini_active = !1, nowuiDashboard.showSidebarMessage('De-activated')) : ($('body').addClass('sidebar-mini'), sidebar_mini_active = !0, nowuiDashboard.showSidebarMessage('Activated...'));
            !0 == sidebar_mini_active ? ($('body').removeClass('sidebar-mini'), sidebar_mini_active = !1) : ($('body').addClass('sidebar-mini'), sidebar_mini_active = !0);
